...
final class Version20260304112351 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT UNSIGNED AUTO_INCREMENT NOT NULL, content LONGTEXT NOT NULL, is_approved TINYINT DEFAULT 0 NOT NULL, created_at DATETIME NOT NULL, user_id INT UNSIGNED NOT NULL, works_id INT UNSIGNED NOT NULL, INDEX IDX_9474526CA76ED395 (user_id), INDEX IDX_9474526CF6CB822A (works_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE contact_message (id INT UNSIGNED AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, email VARCHAR(180) NOT NULL, sujet VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, created_at DATETIME NOT NULL, is_read TINYINT DEFAULT 0 NOT NULL, read_by_id INT UNSIGNED DEFAULT NULL, INDEX IDX_2C9211FEF5675CD0 (read_by_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE formation (id INT UNSIGNED AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, status VARCHAR(20) DEFAULT \'draft\' NOT NULL, created_at DATETIME NOT NULL, published_at DATETIME DEFAULT NULL, updated_at DATETIME DEFAULT NULL, created_by_id INT UNSIGNED NOT NULL, updated_by_id INT UNSIGNED DEFAULT NULL, UNIQUE INDEX UNIQ_404021BF989D9B62 (slug), INDEX IDX_404021BFB03A8386 (created_by_id), INDEX IDX_404021BF896DBBDE (updated_by_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE inscription (id INT UNSIGNED AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, email VARCHAR(180) NOT NULL, message LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, treat TINYINT DEFAULT 0 NOT NULL, treat_at DATETIME DEFAULT NULL, formation_id INT UNSIGNED NOT NULL, treat_by_id INT UNSIGNED DEFAULT NULL, INDEX IDX_5E90F6D65200282E (formation_id), INDEX IDX_5E90F6D6544F38F5 (treat_by_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE partenaire (id INT UNSIGNED AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, url VARCHAR(255) DEFAULT NULL, is_active TINYINT DEFAULT 0 NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE rating (id INT UNSIGNED AUTO_INCREMENT NOT NULL, value SMALLINT UNSIGNED NOT NULL, created_at DATETIME NOT NULL, user_id INT UNSIGNED NOT NULL, INDEX IDX_D8892622A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
