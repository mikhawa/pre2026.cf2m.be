...
/**
 * Historique des révisions filtrées sur les Pages.
 */
class PageRevisionCrudController extends RevisionCrudController
{
    public function configureCrud(Crud $crud): Crud
    {
        return parent::configureCrud($crud)
            ->setEntityLabelInSingular('Révision de page')
            ->setEntityLabelInPlural('Historique des pages')
        ;
    }
