...
/**
 * Historique des révisions filtrées sur les Works.
 */
class WorksRevisionCrudController extends RevisionCrudController
{
    public function configureCrud(Crud $crud): Crud
    {
        return parent::configureCrud($crud)
            ->setEntityLabelInSingular('Révision de work')
            ->setEntityLabelInPlural('Historique des works')
        ;
    }
